# -*- coding: utf-8 -*-
"""
Created on Sat Jun 19 16:41:51 2021
...
model = Create_Model(WIDTH, HEIGHT, 3, LR, output=9, model_name=MODEL_NAME)

model.load('Models for Beach Buggy/Beach_Buggy_v-19.ckpt')
for i in range(1, 25+1):
    file_name = 'training_data/training_data-{}.npy'.format(i)
    print(file_name)
    ...
    model.fit({'input': X}, {'targets': Y}, n_epoch=EPOCHS, validation_set=({'input': test_x}, {'targets': test_y})
          , snapshot_step=525, show_metric=True, run_id=MODEL_NAME)


model.save('Models for Beach Buggy/Beach_Buggy_v-20.ckpt')
